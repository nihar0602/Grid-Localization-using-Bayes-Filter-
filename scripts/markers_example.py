...
def display_line_list(points, publisher):
    ...
    for point in points:
        ...
        marker_point.x = (20 * point[0] + 10) / 100.0
        marker_point.y = (20 * point[1] + 10) / 100.0
        marker_point.z = 0.0
...
def display_cube_list(points, publisher):
    ...
    for i, point in enumerate(points):
        marker_point = Point()  # Create a new Point()
        marker_point.x = point[0] / 100.0
        marker_point.y = point[1] / 100.0
        marker_point.z = 0.0
        marker.points.append(marker_point)  # Append the marker_point to the marker.points list
...
if __name__ == "__main__":
    ...
    line_points = [(0, 0), (0, 0.5), (0, 1), (0, 1.5), (0.5, 2.0), (0.5, 2.5)]
